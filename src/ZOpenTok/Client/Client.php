...
use OpenTok\Util\ClientInterface;
...
class Client implements ClientInterface
{
	...
	{
		// set up the request
		$this->getClient()->setUri('/v2/partner/'.$this->apiKey.'/archive');
		$this->getClient()->setMethod(ZRequest::METHOD_POST);
	...
	{
		// set up the request
		$this->getClient()->setUri('/v2/partner/'.$this->apiKey.'/archive/'.$archiveId.'/stop');
		$this->getClient()->setMethod(ZRequest::METHOD_POST);
		$this->getClient()->getRequest()->getHeaders()->addHeaderLine('Content-Type', 'application/json');
	...
	{
		$this->getClient()->setUri('/v2/partner/'.$this->apiKey.'/archive/'.$archiveId);
